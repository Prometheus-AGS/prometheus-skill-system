---
id: change-evolver-003
title: skills/process/pmpo-evolver/SKILL.md + model routing table
phase: pmpo-evolver
gaps: [G-01, G-13]
...
status: done
scope:
  - skills/process/pmpo-evolver/SKILL.md
  - skills/process/pmpo-evolver/references/model-routing.md
