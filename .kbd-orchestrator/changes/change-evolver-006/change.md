---
id: change-evolver-006
title: Staged idea validation sub-skill (validate-idea)
phase: pmpo-evolver
gaps: [G-08]
...
status: done
scope:
  - skills/process/pmpo-evolver/skills/validate-idea/SKILL.md
  - scripts/idea-gate-1.sh
---
