---
id: change-evolver-010
title: Phase-seeding protocol + liter-llm context management reference
phase: pmpo-evolver
gaps: [G-14]
...
status: done
scope:
  - scripts/evolver-seed-phase.sh
  - references/context-management.md
  - skills/process/liter-llm-bridge/references/model-discovery.md
  - skills/process/pmpo-evolver/references/context-management.md
---
