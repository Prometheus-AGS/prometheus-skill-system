---
id: change-extval-002-sycophancy-corpus
title: Sycophancy gate test corpus
phase: phase-external-validation
priority: P0 (enables G4)
agent: claude-code
status: done
scope:
  - tests/sycophancy-corpus/sycophantic-01.md
  - tests/sycophancy-corpus/honest-01.md
  - tests/sycophancy-corpus/expected-verdicts.json
  - tests/sycophancy-corpus/README.md
---

# change-extval-002-sycophancy-corpus — Sycophancy gate test corpus
