...
version: 1.6.0
generated_at: 2026-07-31T15:11:29Z
skill_count: 146
...
**69 top-level skills** across 17 categories, plus 79 nested sub-skills bundled inside them — 148 total, which is the figure `npm run validate` reports.
