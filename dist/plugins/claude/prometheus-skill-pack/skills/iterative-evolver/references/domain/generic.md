...
Universal assessment and evolution framework for any domain not covered by a specific adapter.

This adapter provides domain-agnostic frameworks that work for any subject requiring iterative improvement.
...
- **Relevance**: Does it align with the broader mission?
- **Timeframe**: Is there a timeline or deadline?
...
- **External resources**: Partners, vendors, communities
...
- **Reliability**: Can it be depended upon?
...
- What external factors affect this goal?

### 5. Risk Identification

- What could prevent goal achievement?
- What external threats exist?
- What internal weaknesses are relevant?
...
4. `"{subject} common challenges and solutions"`
...
- You need a starting framework before switching to a specific adapter
