...
- [x] Pack emits a version manifest (EXTEND skills-index; do not invent a parallel file)
...
- [x] Confirm the 359-commit drift would have been visible through this endpoint
