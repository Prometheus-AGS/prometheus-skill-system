...
- [ ] 1. Add `pmpo-elicit` to the process skills install list in `install-skills-flat.sh`
- [ ] 2. Add `## Platform Mode` section to `SKILL.md`
- [ ] 3. `npm run validate:strict skills/process/pmpo-elicit` passes clean
