...
- [ ] 1. Add operative contested-stack protocol to `kbd-analyze/SKILL.md`
- [ ] 2. Verify no backslash violations introduced (run `npm run validate:skill skills/process/kbd-process-orchestrator`)
