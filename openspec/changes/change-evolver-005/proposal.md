...
**Gaps:** G-10, G-11
**Goals:** G5
**Model class:** small (commit classification); medium (sentiment); frontier (signal synthesis)
**Depends on:** change-evolver-001 (schema with LearningSignal type), change-evolver-002 (feedback source taxonomy)
