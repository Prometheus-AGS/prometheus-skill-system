...
- [ ] 1.1 Extract a reusable local execution facade for submit, status, events, receipt, artifact, and verification without duplicating durable state behavior
...
- [ ] 2.1 Create the `exec-remote` 1.7.0 crate, signed envelope/enrollment/aggregate contracts, feature isolation, and dependency-direction enforcement
...
- [ ] 5.1 Extend OpenAPI, generated request/receipt/MCP references, CLI/config tables, platform/evidence status, component hash, target count, and release drift contracts
