# mcp-client-pool Specification

## Purpose

Defines the MCP client pool behavior for forwarding stdio `tools/call` requests, enforcing allowed tool filters, and surfacing upstream process or JSON-RPC failures.
