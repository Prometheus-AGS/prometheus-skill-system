...
2. Report lifecycle status, plan revision, active lease owner and expiry, last
   completed work, exact next work, pause/block reason, decisions, and drift.
...
This skill is read-only. Do not claim, resume, migrate, repair, or execute work.
